...
export default function Lobby({ onStart, initial }) {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden" data-testid="lobby-screen" style={{ touchAction: "manipulation" }}>
      ...
      <div className="absolute top-3 left-0 right-0 flex items-center justify-between px-3 sm:px-8 py-3 sm:py-5 z-10 gap-2">
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          <span className="hidden sm:inline text-sm font-terminal text-[#6b5d7a]">v1.3 // ink_park</span>
          {!audioReady && (
            <button
      ...
      <div className="absolute inset-0 flex flex-col lg:flex-row pt-16 sm:pt-20 lg:pt-0 pb-32 sm:pb-36 lg:pb-24 overflow-y-auto">
        ...
        <div className="lg:flex-1 flex flex-col justify-center px-5 sm:px-10 lg:pl-16 lg:pr-8 relative">
          <div className="text-[#6b5d7a] font-terminal text-sm sm:text-lg mb-1 ink-cursor">
            // patient_zero.exe
          </div>

          <h1
            className="font-marker ink-title-gold leading-none"
            style={{ fontSize: "clamp(54px, 12vw, 150px)" }}
        ...
        {/* CONTROL PANEL */}
        <div className="w-full lg:w-[440px] flex items-start lg:items-center justify-center px-5 sm:px-10 lg:pr-12 lg:pl-0 mt-6 lg:mt-0">
          <div className="ink-panel p-5 sm:p-7 w-full max-w-md relative">
            <div className="absolute -top-3 left-5 px-2 bg-[#0c0a12] text-[10px] sm:text-xs font-terminal ink-text-purple">
              [ LOBBY :: ENTRY ]
            </div>

            <label className="block text-xs sm:text-sm font-terminal text-[#b4a8c5] mt-2 mb-2 tracking-widest">
              CALLSIGN
            </label>
            <input
            ...
            <label className="block text-xs sm:text-sm font-terminal text-[#b4a8c5] mt-5 sm:mt-6 mb-2 tracking-widest">
            ...
            <input
              ...
              className="w-full accent-[#a855f7] h-6"
            />
            <div className="flex justify-between text-[10px] sm:text-xs font-terminal text-[#6b5d7a] mt-1">
              <span>1</span><span>9</span>
            </div>

            <div className="mt-5 sm:mt-6 text-[11px] sm:text-xs font-terminal text-[#b4a8c5] leading-relaxed">
            ...
            <button
              ...
              onClick={handleStart}
              className="ink-btn toxic w-full mt-6"
            >
              <span>▶ ENTER INK PARK</span>
            </button>

            <div className="mt-3 text-[9px] sm:text-[10px] font-terminal text-[#6b5d7a] text-center tracking-widest leading-relaxed">
      ...
      <div className="absolute bottom-0 left-0 right-0 px-4 sm:px-8 py-3 sm:py-4 border-t border-[#a855f7]/20 bg-[#0c0a12]/85 backdrop-blur-md z-10">
        <div className="flex items-center gap-3 mb-2 flex-wrap">
          ...
          <a
            ...
            download
            className="text-[10px] sm:text-xs font-terminal px-2 sm:px-3 py-1 border border-[#84cc16]/60 ink-text-toxic hover:bg-[#84cc16]/10"
          >
            ⬇ NODE.JS BUILD
          </a>
        </div>
        <div className="flex gap-3 sm:gap-6 overflow-x-auto" data-testid="leaderboard-row">
          {leaderboard.length === 0 ? (
            ...
            <div key={row.nickname} className="flex items-baseline gap-2 whitespace-nowrap">
              ...
              <span className="text-[10px] sm:text-xs font-terminal text-[#b4a8c5]">
